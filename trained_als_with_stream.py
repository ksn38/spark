#/kafka/bin/kafka-topics.sh --create --topic als_kafka --zookeeper 10.0.0.6:2181 --partitions 1 --replication-factor 2 --config retention.ms=-1

#/kafka/bin/kafka-console-producer.sh --topic als_kafka --broker-list 10.0.0.6:6667

#/kafka/bin/kafka-console-consumer.sh --topic als_kafka --bootstrap-server 10.0.0.6:6667
